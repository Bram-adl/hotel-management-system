            ...
            <div class="col-md-4">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        ...
                        <span class="float-right">$ {{ $room[0]->price }}/pernight</span>
                    </li>
                    <li class="list-group-item">
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="rooms" id="rooms" class="form-control @error('rooms') is-invalid @enderror" placeholder="0">
                        </div>
                        @error('rooms')
                        <span class="text-danger text-sm">{{$message}}</span>
                        @enderror
