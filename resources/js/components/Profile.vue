                    ...
                    <div class="col-md-12">
                        <div class="card card-primary card-outline">
                            <div class="card-body box-profile" :style="backgroundPicture">
                                ...
                                <h3 class="profile-username text-center">{{ form.username }}</h3>

                                <p class="text-muted text-center">{{ form.level }}</p>
                            </div>
                            <!-- /.card-body -->
                        </div>
                    </div>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="general">
                                        <form role="form" @submit.prevent="updateUser">
                                            ...
                                            <button type="submit" class="btn btn-block btn-success">Upload profile</button>
                                        </form>
                                    </div>
                                    <!-- /.tab-pane -->
                                </div>
...
export default {
    ...
    methods: {
        ...
        updateUser: function () {
            if ( this.authenticatedUser.level != 'superadmin' ) return
